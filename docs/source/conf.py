...
# -*- coding: utf-8 -*-
#
# asqlcell documentation build configuration file
#
...
_version_py = os.path.join(repo, 'asqlcell', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'asqlcell.tex', 'asqlcell Documentation',
     'qizh', 'manual'),
]
